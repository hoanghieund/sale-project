import { Color, Product, Size, Vendor } from "../types";
...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description:
      "Professional tennis shoes with superior court performance and Rafa-inspired design.",
    price: 140.0,
    originalPrice: 147.0,
  ...
  },
  {
    ...
    description:
      "High-performance basketball shoes designed for explosive cuts and superior court feel.",
    price: 235.0,
    originalPrice: 275.0,
  ...
  },
  {
    ...
    description:
      "Elite soccer cleats engineered for speed and precision on the pitch.",
    price: 130.0,
    originalPrice: 135.0,
  ...
  },
  {
    ...
    description:
      "Waterproof trail running shoes built for all-terrain adventures.",
    price: 200.0,
    originalPrice: 210.0,
    images: ["/assets/product-4.jpg", "/assets/product-5.jpg"],
    category: "running",
    subcategory: "trail",
    brand: "Nike",
  ...
  },
  {
    ...
    description:
      "Retro-inspired lifestyle shoes with unique design and comfortable fit.",
    price: 60.0,
    originalPrice: undefined,
    images: ["/assets/product-5.jpg", "/assets/product-6.jpg"],
    category: "lifestyle",
    subcategory: "retro",
    brand: "Nike",
  ...
  },
  {
    ...
    description:
      "Golf shoes designed for comfort and performance on the course.",
    price: 89.75,
    originalPrice: undefined,
    images: ["/assets/product-6.jpg", "/assets/product-7.jpg"],
    category: "golf",
    subcategory: "performance",
    brand: "Nike",
  ...
  },
  {
    ...
    price: 66.48,
    originalPrice: undefined,
    images: ["/assets/product-7.jpg", "/assets/product-1.jpg"],
    category: "kids",
  ...
  },
  {
    ...
    description:
      "Versatile training shoes perfect for gym workouts and casual wear.",
    price: 83.9,
    originalPrice: undefined,
    images: ["/assets/product-1.jpg", "/assets/product-2.jpg"],
    category: "fitness",
...
export const FEATURED_PRODUCTS = MOCK_PRODUCTS.filter(
...
export const BEST_SELLERS = MOCK_PRODUCTS.sort(
