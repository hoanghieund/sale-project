      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <div className="mt-8">
            ...
            <p className="mb-4">
              When you see the blue tick <CheckCircle className="inline h-5 w-5 text-blue-600" />, know that it has been 
          ...
          <div className="mt-8">
            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-4 text-blue-900">Photo Requirements by Category:</h3>
          ...
          {/* Verification */}
          <div className="mt-8">
            <h5 className="text-xl font-bold text-gray-900 mb-4">Verification.</h5>
            ...
            <div className="mb-6">
              <p className="font-semibold text-gray-900 mb-4">What happens if…</p>
          ...
          <div className="mt-8">
            <Card className="bg-yellow-50 border-yellow-200">
              <CardContent className="p-6">
                <p className="font-semibold text-yellow-900 mb-4">Important Note*</p>
                ...
                <p className="text-yellow-800">
                  ...
                  <Link to="/shipping-returns" className="text-yellow-700 hover:underline font-medium">
                    <strong>here</strong>
                  </Link>.
                </p>
              </CardContent>
